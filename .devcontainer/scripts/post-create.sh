...
generate_typechain() {
    ...
    if npx hardhat diamond:generate-abi-typechain --diamond-name GNUSDAODiamond; then
...
display_next_steps() {
    log_success "GNUS-DAO DevContainer setup completed!"
    echo
    log_info "Next steps:"
...
# Main execution
main() {
    log_info "Starting GNUS-DAO post-create setup..."
