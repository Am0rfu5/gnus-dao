# GNUS-DAO DevContainer

A comprehensive, reproducible development environment for the GNUS-DAO Ethereum smart contract project using ERC-2535 Diamond Proxy Standard.
...
npx hardhat diamond:generate-abi-typechain --diamond-name GNUSDAODiamond
...
GNUS-DAO uses ERC-2535 Diamond Proxy Standard for upgradeable contracts:
...
This DevContainer configuration is part of the GNUS-DAO project. See project LICENSE for details.

---

**Happy coding! 🚀**

*Built with ❤️ for secure, scalable DeFi development*